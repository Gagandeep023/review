...
<div class="container">
    <h2 style="margin-top: 12px;" class="alert alert-success">Practice with expert-
    <a href="https://faangmock.tech/" target="_blank" >Faangmock</a>
     </h2><br>
     <div class="row" style="clear: both;margin-top: 18px;">
       <div class="col-12 text-right">
          <a href="/loginpage" class="navbar-brand">
